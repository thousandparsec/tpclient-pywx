...
"""
	...
	xrc = os.path.join(location(), "windows", "xrc", 'winCategoriesManager.xrc')
	...
	def __init__(self, parent, *args, **kw):
		...
		if not res.LoadOnFrame(pre, parent, "CategoriesManager"):
			raise IOError("Did not find the CategoriesManager in the XRC file")
		self.PreCreate(pre)
		self.PostCreate(pre)

		# Define variables for the controls
		self.Panel = XRCCTRL(self, "Panel")
		self.CategoriesList = XRCCTRL(self, "CategoriesList")
