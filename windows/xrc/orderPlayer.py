...
class orderPlayerBase(wx.Panel):
	xrc = os.path.join(location(), "windows", "xrc", 'orderPlayer.xrc')
	...
	def __init__(self, parent, *args, **kw):
		...
		pre = wx.PrePanel()
		if not res.LoadOnPanel(pre, parent, "orderPlayer"):
			raise IOError("Did not find the orderPlayer in the XRC file")
		self.PreCreate(pre)
		self.PostCreate(pre)
