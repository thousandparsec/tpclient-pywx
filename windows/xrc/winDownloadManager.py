...
"""
	...
	xrc = os.path.join(location(), "windows", "xrc", 'winDownloadManager.xrc')
	...
	def __init__(self, parent, *args, **kw):
		...
		if not res.LoadOnFrame(pre, parent, "winDownloadManager"):
			raise IOError("Did not find the winDownloadManager in the XRC file")
		self.PreCreate(pre)
		self.PostCreate(pre)
